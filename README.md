...
py -m producers.json_producer_tesfai
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m producers.json_producer_tesfai
```
...
```shell
.venv\Scripts\activate
py -m consumers.json_consumer_tesfai
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m consumers.json_consumer_tesfai
```
