...
def get_kafka_topic() -> str:
    ...
    topic = os.getenv("SMOKER_TOPIC", "csv_topic")  # Default topic is csv_topic
...
def get_kafka_consumer_group_id() -> str:
    ...
    group_id: str = os.getenv("SMOKER_CONSUMER_GROUP_ID", "csv_group")  # Default group is csv_group
...
def get_stall_threshold() -> float:
    ...
    temp_variation = float(os.getenv("SMOKER_STALL_THRESHOLD_F", 0.2))  # Default stall threshold is 0.2°F
...
def get_rolling_window_size() -> int:
    ...
    window_size = int(os.getenv("SMOKER_ROLLING_WINDOW_SIZE", 5))  # Default window size is 5
